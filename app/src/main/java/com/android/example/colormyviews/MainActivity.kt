...
class MainActivity : AppCompatActivity() {
    ...
    private fun makeImage(view: View) {
        when (view.id) {
            ...
            R.id.box_four_text -> view.setBackgroundResource(R.drawable.ic_launcher_background)
            R.id.box_five_text -> view.setBackgroundResource(R.drawable.ic_launcher_background)
